...
public class Test {
	public static void main(String args[]) throws IOException, JSONException {		
		String ret=getPriceEstimateAndTimeToDestinationOfUber((float)37.7833,(float)-122.4167,(float)34.073042, (float)-118.446901,"uberX");
		System.out.println(ret);
		}
	
	
	static String getTimeEstimateOfUber(float start_latitude,float start_longitude,String product_id) throws IOException, JSONException
	{
		
		String url = "https://api.uber.com/v1/estimates/time?server_token=BKYQvDBHqGST82NeyoAY9gaTC3E85jxN6IpK7tRY&"
				+ "start_latitude="+start_latitude+"&start_longitude="+start_longitude+"&product_id="+product_id;
	...
	static String getPriceEstimateAndTimeToDestinationOfUber(float start_latitude,float start_longitude,float end_latitude,float end_longitude,String product_name) throws IOException, JSONException
	{
	...
	static String getProducts(float start_latitude,float start_longitude,String productName) throws IOException, JSONException
	{
